<nav x-data="{ open: false }" class="fixed w-11/12 h-20 ml-4 bg-gray-900 border rounded-xl lg:ml-12 sm:ml-8" style="box-shadow: #5EE0D6 5px 5px 10px;
">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="flex items-center -mr-2 sm:hidden">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 text-gray-400 transition rounded-md hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500">
                    <svg class="w-6 h-6" stroke="currentColor" fill="none" viewBox="0 0 24 24" class="bg-white">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden bg-gray-900 rounded-md sm:hidden">
